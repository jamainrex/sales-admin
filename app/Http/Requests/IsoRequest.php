...
class IsoRequest extends FormRequest
{
    ...
    {
        //"business_name" => "IBM"
        //"contact_name" => "Cristine Quibiquibo"
        //"contact_number" => "9173100456"
        return [
            'business_name' => 'required',
            'contact_name' => 'required',
            'contact_number' => 'required|phone:US',
            //'emails.*.email' => 'email|unique',
    ...
    {
        return [
            'contact_number.phone' => 'Contact Number is invalid US Phone Number'
        ];
    }
}
