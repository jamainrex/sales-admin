...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('iso') }}'><i class='nav-icon la la-question'></i> Iso</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('sic') }}'><i class='nav-icon la la-question'></i> Sic</a></li>
